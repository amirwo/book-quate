package com.gama.quatenation.utils.ui;
...
public class QustomDialogBuilder extends AlertDialog.Builder{
    ...
    public QustomDialogBuilder setDividerColor(int colorInt) {
    ...
    public QustomDialogBuilder setTitleColor(int colorInt) {
    ...
    public QustomDialogBuilder setMessageBGColor(int bgColor) {
        mMessage.setBackgroundColor(bgColor);
        return this;
    }
